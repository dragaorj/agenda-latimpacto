-- ============================================================
-- Migração: idiomas da sessão + "Palestrantes em processo de confirmação"
-- Rode UMA vez no SQL Editor do Supabase. Seguro rodar de novo.
-- ============================================================

alter table public.talks
  add column if not exists speakers_pending boolean default false,
...
begin
  ...
  on conflict (id) do update set
    ...
    langs=excluded.langs, title=excluded.title, descr=excluded.descr,
